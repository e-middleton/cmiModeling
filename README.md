...
## Data Sources
GPS data in cumulative_disp.txt is from the first 2 years after the 2011 Tohoku-oki earthquake, from Hu et al. doi:10.1186/1880-5981-66-106 

seafloor data that was appended onto `cumulative_disp.txt` for `cumulative_disp_seafloor.txt` was sourced from Watanabe et al. doi.org/10.1002/2014GL061134 in their supplementary materials section, taking the dates closest to 2 years and 
